...
void MainWindow::createActions()
{
    ...
    freePenAct = new QAction(tr("&Pen"),this);
    connect(freePenAct,SIGNAL(triggered()),scribbleArea,SLOT(drawFreePen()));

    lineAct = new QAction(tr("&Line"),this);
    connect(lineAct,SIGNAL(triggered()),scribbleArea,SLOT(drawLine()));

    rectAct = new QAction(tr("&Rectangle"),this);
    connect(rectAct,SIGNAL(triggered()),scribbleArea,SLOT(drawRect()));

    circleAct = new QAction(tr("&Circle"),this);
    connect(circleAct,SIGNAL(triggered()),scribbleArea,SLOT(drawCircle()));
